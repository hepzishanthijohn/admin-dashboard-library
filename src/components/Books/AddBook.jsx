                ...
                <div className="row mt-4 ps-5">
                    <div className="col-lg-5  mt-5 m-auto">
                        ...
                        <textarea rows="3" cols="3"
                            type="text"
                            className={`form-control ${myFormik.touched.publication_Date && myFormik.errors.publication_Date ? "is-invalid" : "is-valid"}`}
                            value={myFormik.values.publication_Date}
                            name="publication_Date"
                            placeholder="Enter book's publication_Date"
                            onBlur={myFormik.handleBlur}
                            onChange={myFormik.handleChange}>
                        </textarea><span style={{ color: "red", fontSize: ".5" }} >{myFormik.touched.publication_Date && myFormik.errors.publication_Date ? myFormik.errors.publication_Date : null}</span><br />
